...
$Policy2 = New-AzureRmPolicyDefinition -Name $Policy2Name -Description “Policy to allow only Application Security Group (ASG) names meeting Generali's naming convention” -Policy "$path\$Policy2Name.json"
...
$Policy4 = New-AzureRmPolicyDefinition -Name $Policy4Name -Description “Policy to allow only Network Security Group (NSG) names meeting Generali's naming convention” -Policy "$path\$Policy4Name.json"
$Policy5 = New-AzureRmPolicyDefinition -Name $Policy5Name -Description “Policy to allow only Storage Account names meeting Generali's naming convention” -Policy "$path\$Policy5Name.json"
$Policy6 = New-AzureRmPolicyDefinition -Name $Policy6Name -Description “Policy to allow only Subnet names meeting Generali's naming convention” -Policy "$path\$Policy6Name.json"
$Policy7 = New-AzureRmPolicyDefinition -Name $Policy7Name -Description “Policy to allow only Virtual Machine (VM) names meeting Generali's naming convention” -Policy "$path\$Policy7Name.json"
$Policy8 = New-AzureRmPolicyDefinition -Name $Policy8Name -Description “Policy to allow only Virtual Network names meeting Generali's naming convention” -Policy "$path\$Policy8Name.json"
